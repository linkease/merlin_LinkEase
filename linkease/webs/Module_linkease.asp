...
function init(){
    ...
    if (linkease_website_en == "0") {
        ...
        $G('linkease_website').disabled = false;
    }
}
...
<form method="POST" name="form" action="/applydb.cgi?p=linkease_" target="hidden_frame">
    ...
    <input type="hidden" id="linkease_enable" name="linkease_enable" value='<% dbus_get_def("linkease_enable", "0"); %>'/>
                                ...
                                <tr>
                                    <td bgcolor="#4D595D" colspan="3" valign="top"><div>&nbsp;</div>
                                        ...
                                        <div class="SimpleNote">
                                            ...
                                            <li><i>使用教程：</i><a href="http://koolshare.cn/thread-129199-1-1.html" target="_blank"><i>EasyExplorer文件同步使用教程</i></a>&nbsp;&nbsp;<a href="https://github.com/koolshare/rogsoft/blob/master/linkease/Changelog.txt" target="_blank"><em><u>[ 插件更新日志 ]</u></em></a></li>
                                        ...
                                        <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                            ...
                                            <tr id="switch_tr">
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <div id="linkease_version_show" style="padding-top:5px;margin-left:30px;margin-top:0px;float: left;">插件版本：<% dbus_get_def("linkease_version", "未知"); %></div>
                                                    <div id="linkease_changelog_show" style="padding-top:5px;margin-right:50px;margin-top:0px;float: right;"><a href="https://raw.githubusercontent.com/koolshare/merlin_EasyExplorer/master/Changelog.txt" target="_blank"><em><u>[ 更新日志 ]</u></em></a></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th>Token/令牌</th>
                                                <td>
                                                    <input style="width:300px;background-image: none;background-color: #576d73;border:1px solid gray" type="password" class="input_ss_table" id="linkease_token" name="linkease_token" maxlength="100" value="" autocomplete="new-password" autocorrect="off" autocapitalize="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>共享目录</th>
                                                <td>
                                                 <input type="text" class="input_ss_table" style="width:auto;" name="linkease_dir" value="" maxlength="50" size="40" ondblClick="get_disk_tree();" id="linkease_dir"> <i>双击选择路径</i>
                                                </td>
                                              </tr>
                                            <tr id="rule_update_switch">
                                                <th>管理/帮助</th>
                                                <td>
                                                    <a type="button" class="linkease_btn" style="cursor:pointer" target="_blank" href="https://www.ddnsto.com">获取Token</a>
                                                    <a type="button" class="linkease_btn" id="linkease_website" style="cursor:pointer">访问EasyExplorer</a>
                                                </td>
                                            </tr>
                                        </table>
